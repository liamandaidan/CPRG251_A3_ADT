...
class SerializationTests {
	...
	public void testDataValues() throws IndexOutOfBoundsException {
		...
		// Test the size is 4
		assertEquals(4, this.users.size());

		// Test the first node value is a
		assertEquals("Joe Blow", ((User) this.users.retrieve(0)).getName());
		assertEquals("jblow@gmail.com", ((User) this.users.retrieve(0)).getEmail());
